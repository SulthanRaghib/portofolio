    ...
    <section id="about" className="py-20 bg-muted">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <SpotlightCard className="p-8">
            <div className="flex flex-col items-center lg:items-start">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-primary font-semibold mb-1">Web Developer | Backend Engineer</p>
                <p className="text-primary/80 font-medium text-sm mb-1">
                  S.Kom — STT Terpadu Nurul Fikri
                </p>
                <p className="text-primary/80 font-medium text-sm mb-4">GPA: 3.83</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-16">
          ...
          <div className="text-center">
            <div className="text-4xl font-heading font-black text-primary mb-2">
              <CountUp from={0} to={3} suffix=".83" duration={2.5} />
            </div>
            <div className="text-muted-foreground">GPA</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-heading font-black text-primary mb-2">
              <CountUp from={0} to={1} suffix="+" duration={2.5} />
            </div>
