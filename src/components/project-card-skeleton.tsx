...
export function ProjectCardSkeleton({ prominent = false, delay = 0 }: Props) {
  const imgClass = prominent ? "h-72 md:h-80 lg:h-96" : "h-52 md:h-56 lg:h-64";
  ...
  return (
    ...
    >
      ...
      <CardContent className="p-6 md:p-7 flex-1 flex flex-col relative">
